...
class image_gan():
    ...
    def generator(self, z):
        ...
        g_w3, g_b3 = self.weights('g_dew3', [3, 3, g_dim * 2, g_dim * 4], 0.02, 0.02)
        ...
        g_w4, g_b4 = self.weights('g_dew4', [3, 3, g_dim * 1, g_dim * 2], 0.02, 0.02)
        ...
        # Generate g_dim * 2
        g_w5, g_b5 = self.weights('g_dew5',[3, 3, 3, g_dim * 1], 0.02, 0.02)
